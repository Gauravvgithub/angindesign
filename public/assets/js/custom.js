...
function magnific_popup() {
  jQuery('.single-gallery').each(function () {
    jQuery(this).magnificPopup({
      delegate: '.mfp-link', // only links with class mfp-link
      type: 'image',
      tLoading: 'Loading...',
      gallery: {
        enabled: true,
      ...
      callbacks: {
        elementParse: function (item) {
          // ensure only images open in popup
          if (!item.src.match(/\.(jpg|jpeg|png|gif|webp)$/i)) {
            item.type = 'inline'; // skip video
          }
        }
      }
    });
...
/* =====================================
All JavaScript fuctions End
======================================*/	

// SIMPLE FILTER (NO ISOTOPE)
(function () {
  ...
  filterButtons.forEach(btn => {
    btn.addEventListener("click", function (e) {
      ...
      // active class
      filterButtons.forEach(b => b.parentElement.classList.remove("active"));

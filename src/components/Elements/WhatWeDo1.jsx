              ...
              <div className="row number-block-one-outer justify-content-center">
                <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                  <div className="number-block-one animate-in-to-top">
                    ...
                    />
                    <div className="figcaption bg-white text-center p-a20" style={{borderRadius:"20px"}}>
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-12 col-sm-12">
                    <div className="large-title">
                      <h3 className="m-tb0">
                        Modern Solutions to Interior Design
                      </h3>
                    </div>
                  </div>
                  <div className="col-lg-6 col-md-12	col-sm-12">
                    <div className="large-title-info">
                      <p>
                        ...
                        uses of light, textures, and space, create an interior
                        space that magnifies...
                      </p>
                      <div className="text-left">
                        <NavLink to={"/projects"} className="site-button-link">
                          Read More
                        </NavLink>
                      </div>
                    </div>

                            ...
                            <div className="row">
                                <div className="col-xl-6 col-lg-6 col-md-12">
                                    <div className="about-home-3 m-b30 bg-white">
                                        ...
                                        <p>Ang Indesign is a team of highly talented, experienced, and award-winning architects and designers. Our company has been the leading provider of architecture services to clients throughout the USA since 1999. We pay attention to every demand...</p>
                                        <ul className="list-angle-right anchor-line">
                                            <li><NavLink to="/about">We provide a architectural 3D modeling services.</NavLink></li>
                                            <li><NavLink to="/about">Our specialists are ready to consult you on any topic.</NavLink></li>
                                            <li><NavLink to="/about">We develop and implement better interior design.</NavLink></li>
                                            <li><NavLink to="/about">We provide high-quality interior services for clients.</NavLink></li>
                                        </ul>

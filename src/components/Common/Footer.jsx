...
import { NavLink } from "react-router-dom";
import Switcher from "../Elements/Switcher";
import { useGetRecentBlogsQuery } from "../../store/servicesApi";

const Footer = () => {
  const { data: recentBlogs, isLoading, isError } = useGetRecentBlogsQuery();
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="widget widget_about">
                  ...
                  <p>
                    Ang Indesign creates innovative, sustainable interior spaces
                    that elevate modern living.
                  </p>
                  <ul className="social-icons sx-social-links">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="widget widget_address_outer">
                  <h5 className="widget-title">Contact Us</h5>
                  <ul className="widget_address">
                    <li>Dwarka Delhi, India - 110075</li>
                    <li>Info@angindesign.com</li>
                    <li>+91 7530919656</li>
                  </ul>
                </div>

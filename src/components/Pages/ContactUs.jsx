  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://angindesign.com/contact-us" />
              ...
              <div className="row">
                <div className="col-lg-8 col-md-12 col-sm-12">
                  ...
                  <div className="p-b40 m-t50">
                    ...
                    <p>
                      We are here to help you in a calm, clear, and focused way.
                      Don't worry if you're not sure what to do first when
                      planning your interiors. You can reach out anytime for
                      design help, project guidance, materials, or simply to
                    ...
                    >
                      ...
                      <div className="panel sx-panel">
                        ...
                        <div id="faqThree" className="acod-body collapse">
                          <div className="acod-content p-a15">
                            <p>
                              If you have one, that’s great! If not, no worries
                              — we can still help you with your requirements.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="panel sx-panel">
                        ...
                        <div id="faqFive" className="acod-body collapse">
                          <div className="acod-content p-a15">
                            <p>
                              Yes, site visits can be arranged after the initial
                              discussion.
                            </p>
                          </div>
                        </div>
                    ...
                    <p>
                      ...
                      knowledgeable, and professional guide. We are here to make
                      everything smooth and enjoyable.
                    </p>
                    <ul className="list-angle-right anchor-line">
                      <li>
                        {" "}
                ...
                <div className="col-lg-4 col-md-12 col-sm-12">
                  {/* Contact Info Box remains unchanged */}
                  <div
                    ...
                    <div>
                      ...
                      <div className="sx-icon-box-wraper left">
                        ...
                        <div className="icon-content">
                          ...
                          <p>Dwarka, New Delhi 110075 - India</p>
                        </div>
                      </div>
                    </div>
                  </div>

...
import { useGetBlogByIdQuery } from "../../store/servicesApi";

const BlogSingle = () => {
  const { slug } = useParams();

  // ✅ RTK Query hook
  const { data: blog, isLoading, isFetching } = useGetBlogByIdQuery(slug);
              ...
              <div className="blog-post blog-detail text-black">
                ...
                <div className="sx-post-meta m-t20">
                  <ul>
                    ...
                    <li className="post-author">
                      <NavLink to="#">By <span>Admin</span></NavLink>
                    </li>
                  </ul>
                </div>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="widget_tag_cloud m-b15">
                        ...
                        <div className="tagcloud">
                          {seo.metaKeywords?.split(",").map((tag, index) => (
                            <NavLink key={index} to="#">{tag.trim()}</NavLink>
                          ))}
                        </div>
                      </div>
                    </div>
